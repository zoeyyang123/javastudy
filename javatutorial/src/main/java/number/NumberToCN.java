...
public final class NumberToCN {
    ...
    public NumberToCN(double amount) {
        this.amount = amount;
    }
...
*/
    ...
    public static void main(String[] args) {
        System.out.println(NumberToCN.toBigAmt(10052345.00D));
        System.out.println(NumberToCN.toBigAmt(0.00D));
        System.out.println(NumberToCN.toBigAmt(0.60D));
        System.out.println(NumberToCN.toBigAmt(00.60D));
        System.out.println(NumberToCN.toBigAmt(150.2101D));
        System.out.println(NumberToCN.toBigAmt(15400089666.234D));
        System.out.println(NumberToCN.toBigAmt(22200004444.2347D));
    }
}
